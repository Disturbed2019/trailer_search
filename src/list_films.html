    ...
    <main class="main admin">
        <div class="container">
            <div class="admin__wrapper">
                <a class="btn btn__primary" href="./list_users.html">Список пользователей</a>
                <a class="btn btn__primary" href="./list_films.html">Список фильмов</a>
                <a class="btn btn__primary" href="./add_film.html">Добавить фильм</a>
            </div>
            <div class="films">
                <ul class="films__list">
                    <li class="films__item">
                        ...
                        <div class="films__btns">
                            <button class="btn btn__primary delete_film">Удалить фильм</button>
                            <a href="./edit_film.html" class="btn films__delete ">Редактировать фильм</a>
                        </div>
                    </li>
                    <li class="films__item">
                        <div class="films__thumb">
